...
CREATE TABLE `app_audit` (
  ...
  `modify_time` timestamp NOT NULL DEFAULT '2018-10-23 10:00:00',
...
CREATE TABLE `app_client_costtime_minute_stat` (
  ...
  `instance_host` varchar(100) DEFAULT NULL COMMENT '客户端上报实例ip',
...
CREATE TABLE `app_client_costtime_minute_stat_total` (
  ...
  `max_instance_host` varchar(100) DEFAULT NULL COMMENT '客户端上报最大耗时对应的实例ip',
  ...
  `max_client_ip` varchar(100) NOT NULL COMMENT '最大耗时对应的客户端ip',
...
CREATE TABLE `app_client_version_statistic` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `app_id` bigint(20) NOT NULL COMMENT '应用id',
  `client_ip` varchar(100) NOT NULL COMMENT '客户端ip地址',
...
CREATE TABLE `app_hour_command_statistics` (
  ...
  `modify_time` timestamp NOT NULL DEFAULT '2018-10-23 10:00:00' COMMENT '修改时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `app_hour_statistics` (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `modify_time` timestamp NOT NULL DEFAULT '2018-10-23 10:00:00' COMMENT '每小时修改时间最大值',
  PRIMARY KEY (`id`),
...
CREATE TABLE `instance_host` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `ip` varchar(100) NOT NULL COMMENT '机器ip',
...
CREATE TABLE `instance_info` (
  ...
  `ip` varchar(100) NOT NULL COMMENT '实例的ip',
...
CREATE TABLE `machine_info` (
  ...
  `real_ip` varchar(100) COLLATE utf8_bin NOT NULL COMMENT '宿主机ip',
  `service_time` timestamp NOT NULL DEFAULT '2018-10-23 10:00:00' COMMENT '上线时间',
...
CREATE TABLE `instance_slow_log` (
  ...
  `create_time` timestamp NOT NULL DEFAULT '2018-10-23 10:00:00' COMMENT '记录创建时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `app_client_instance` (
  `app_id` bigint(20) NOT NULL COMMENT '应用id',
  `client_ip` varchar(100) NOT NULL COMMENT '客户端ip',
  `instance_host` varchar(100) NOT NULL COMMENT 'redis节点ip',
